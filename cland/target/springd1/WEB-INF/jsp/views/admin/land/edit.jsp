...
<div class="row">
		<div class="col-md-12 panel-info">
			...
			<form method="post" action="${pageContext.request.contextPath}/admin/land/update/${land.lid}" enctype="multipart/form-data">
				<div>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input name="lname" id="name" value="${land.lname}" type="text" class="form-control" placeholder="">
							...
							<div class="form-group">
								...
								<input name="address" id="address" type="text" value="${land.address}" class="form-control" placeholder="Địa chỉ">
								<form:errors path="ld.address" cssClass="errors" />
							</div>
							
							<div class="form-group">
								<label for="area">Diện tích</label>
								<input name="area" id="area" type="text" value="${land.area}" class="form-control" placeholder="Diện tích ex:1000 m2">
