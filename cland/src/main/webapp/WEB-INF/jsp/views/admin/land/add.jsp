...
<div class="row">
		<div class="col-md-12 panel-info">
			...
			<form method="post" action="${pageContext.request.contextPath}/admin/land/add"
			 enctype="multipart/form-data" id="land-form">
				<div>
...
$().ready(function() {
	$("#land-form").validate({
		...
		messages: {
			"lname": {
				required: "Bắt buộc nhập tên nhà đất",
			...
			"area": {
				required: "Bắt buộc nhập diện tích",
			}
		}
	});
});
